...
| Web | `npm run build` clean, 186 tests + axe green, contrast pairs pass; **live end-to-end click-through captured** (headless Chrome through real login → /safety entry → receipt → supersede → deadlines, handoff 0010 frontend evidence) | — |
